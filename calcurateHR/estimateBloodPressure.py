...
if __name__ == '__main__':
    ...
    # OUTPUT_FILE ="C:\\Users\\kine0\\tumuraLabo\\eyeground\\result\\1211-interpolate\\result-2.csv"
    #データをdfに読み込み。pandasをpdとして利用。
    df = pd.read_csv("C:\\Users\\kine0\\tumuraLabo\\eyeground\\result\\1211-interpolate\\result-2.csv",header=None)

    pulse = df.to_numpy()
    print(pulse)
    print(argrelmin(pulse,order=12))


    # ピーク検出
    peak1, peak2 = detect_pulse_peak(pulse, SAMPLE_RATE)
